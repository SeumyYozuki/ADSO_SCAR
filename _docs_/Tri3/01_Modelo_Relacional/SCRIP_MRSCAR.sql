...
CREATE TABLE IF NOT EXISTS `BD_SCAR`.`DOMICILIOS` (
  ...
  `REPARTIDORES_repartidor_id` INT NULL COMMENT 'Llave foránea opcional que asigna al repartidor en REPARTIDORES',
  `VENTAS_venta_id` INT NOT NULL,
  PRIMARY KEY (`domicilio_id`),
  INDEX `fk_DOMICILIOS_REPARTIDORES1_idx` (`REPARTIDORES_repartidor_id` ASC) VISIBLE,
